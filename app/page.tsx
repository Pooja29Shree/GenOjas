...
export default function Home() {
  ...
  const handleGetStarted = () => {
    router.push("/voice"); // navigate to new page
  };
    ...
    <AuroraBackgroundHome>
      <div className="relative select-none z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        <Button
          ...
          className="cursor-pointer my-5 bg-gradient-to-r from-pink-500 to-purple-600 text-white z-10 hover:shadow-[0px_0px_25px_0px_#f0abfc] hover:scale-110 active:scale-95 transition-all ease-in-out"
        >
          Get Started
        </Button>
      </div>
