  ...
  return (
    <>
      <AuroraBackgroundHome>
        <div className="relative select-none z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center mb-20">
          <Image
            src="/logo.png"
            alt="Gen Ojas Logo"
            width={300}
          ...
          <Link href="/login"> 
            <Button
              variant="default"
              size="lg"
              className="cursor-pointer my-5 bg-gradient-to-r font-inter from-blue-700 to-blue-400 z-10 hover:shadow-[0px_0px_25px_0px_#93c5fd] hover:scale-110 active:scale-95 transition-all ease-in-out"
            >
              Get Started
            </Button>
          </Link>
